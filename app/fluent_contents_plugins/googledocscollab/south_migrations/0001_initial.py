...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GoogleDocsCollabItem'
        db.create_table('contentitem_googledocscollab_googledocscollabitem', (
        ...
        db.send_create_signal('googledocscollab', ['GoogleDocsCollabItem'])


    def backwards(self, orm):
        
        # Deleting model 'GoogleDocsCollabItem'
        db.delete_table('contentitem_googledocscollab_googledocscollabitem')
    ...
    models = {
        ...
        'googledocscollab.googledocscollabitem': {
            'Meta': {'ordering': "('placeholder', 'sort_order')", 'object_name': 'GoogleDocsCollabItemItem', 'db_table': "'contentitem_googledocscollab_googledocscollabitem'", '_ormbases': ['fluent_contents.ContentItem']},
    ...
    complete_apps = ['googledocscollab']
